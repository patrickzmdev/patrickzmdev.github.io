  ...
  return(
    <footer className='page-footer' id='footer'>
       <div className='social'>
          ...
          target="_blank"><i class="fa-brands fa-linkedin" id="icon-linkedin"></i></a>
          <a href="https://github.com/patrickzmdev" rel="noopener noreferrer"
          target="_blank"><i class="fa-brands fa-github" id="icon-github"></i></a>
          <a href="https://api.whatsapp.com/send/?phone=5548988174195&type=phone_number" rel="noopener noreferrer"
          target="_blank"><i class="fa-brands fa-whatsapp" id="icon-whatsapp"></i></a>
       </div>
       <div class="copyright">
